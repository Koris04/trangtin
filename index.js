...
var uri = 'mongodb+srv://Koris:0704895488Tr@koris.maf4d.mongodb.net/trangtin?retryWrites=true&w=majority&appName=Koris';
...
app.use(session({
	...
	secret: 'koris',		// Khóa bảo vệ (tự chọn)
	resave: false,
...
app.listen(3000, () => {
	console.log('Server is running at https://trangtin-mvbq.onrender.com');
});